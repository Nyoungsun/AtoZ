...
import style from '../../css/GetMySentiment/GetMySentimentM.module.css';

const GetMySentimentMobile = (props) => {
...
export default GetMySentimentMobile;